...
export const Button: React.FC<ButtonProps> = ({ variant = 'primary', size = 'md', className = '', icon, children, type = 'button', ...props }) => {
...
export const Modal: React.FC<ModalProps> = ({ isOpen, onClose, title, children, maxWidth = 'max-w-lg' }) => {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className={`bg-white rounded-lg shadow-xl w-full ${maxWidth} overflow-hidden transform transition-all flex flex-col max-h-[90vh]`}>
